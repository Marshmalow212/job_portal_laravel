...
<head>
    ...
    <title>Verify Your Email</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: center;">
            				<h2>One Step Away from Job Search!</h2>
            				<h3>click the link below to verify your email</h3>
            				<p><a href=<?=$link?> class="btn btn-primary">Verify Email</a></p>
            			</div>
            		</td>
            	</tr>
            </table>
